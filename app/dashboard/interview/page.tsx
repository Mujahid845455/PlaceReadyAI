    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl p-6 mb-6 border border-gray-200">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Answer questions about your React.js project</p>
            </div>
            <div className="text-right">
              <div className="text-sm text-gray-600">Question</div>
              <div className="text-2xl font-bold text-blue-600">{currentQuestion} / {questions.length}</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-8 mb-6 border border-gray-200">
          {/* Question */}
          <div className="mb-8">
            <div className="text-sm font-semibold text-gray-500 mb-2">CURRENT QUESTION</div>
          ...
          <div className="flex gap-4 mt-8">
            <button 
              ...
              className="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center"
            >
              <SkipForward className="h-5 w-5 mr-2" />
              {currentQuestion >= questions.length ? 'Last Question' : 'Skip Question'}
            </button>
            
            <button className="flex-1 bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition flex items-center justify-center">
            ...
            <Link 
              ...
              className="flex-1 bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition flex items-center justify-center"
            >
